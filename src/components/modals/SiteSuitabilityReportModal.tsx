        ...
        <div className="p-3.5 sm:p-6 border-b border-[#DCE7E1] bg-[#F6F9F7] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center space-x-2.5 sm:space-x-3">
            ...
            <div className="min-w-0">
              <h2 className="text-sm sm:text-base font-black text-[#17221D] truncate">Site Suitability & Capacity Report</h2>
          ...
          <div className="flex items-center justify-end space-x-2 shrink-0">
            <button onClick={handlePrint} className="px-2.5 sm:px-3 py-1.5 bg-white border border-[#DCE7E1] rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-50 flex items-center space-x-1 min-h-[38px] cursor-pointer">
              <Printer className="w-3.5 h-3.5" />
              <span>Print</span>
            </button>
            <button onClick={handleDownload} className="px-2.5 sm:px-3 py-1.5 bg-[#087F5B] text-white rounded-xl text-xs font-bold hover:bg-[#07543F] flex items-center space-x-1 shadow-sm min-h-[38px] cursor-pointer">
              <Download className="w-3.5 h-3.5" />
              <span>Export PDF</span>
            </button>
            <button onClick={onClose} className="p-1.5 sm:p-2 rounded-xl hover:bg-slate-200 text-slate-500 min-h-[38px] min-w-[38px] flex items-center justify-center cursor-pointer" aria-label="Close report">
              <X className="w-5 h-5" />
            </button>
          </div>
        </div>
