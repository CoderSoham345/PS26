  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn">
      <div className="bg-white border border-[#DCE7E1] p-6 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-extrabold text-[#17221D] mb-1">AI Relocation Prioritization Dashboard</h1>
          <p className="text-xs text-slate-600">Explainable multi-tier relocation scheduling based on exposure and vulnerability</p>
        </div>
      ...
      <div className="space-y-6">
        {priorityTiers.map((tier) => {
          ...
          return (
            <div key={tier} className="bg-white border border-[#DCE7E1] rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#DCE7E1]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {tierHabitations.map((hab) => (
                  <div key={hab.id} className="bg-[#F6F9F7] border border-[#DCE7E1] rounded-xl p-5 flex flex-col justify-between shadow-sm">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <h3 className="text-sm font-bold text-[#17221D]">{hab.name}</h3>
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-[#DCE7E1]">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#087F5B] hover:bg-[#07543F] text-white font-semibold text-xs rounded-xl transition-colors flex items-center space-x-1 shadow-sm"
                      >
